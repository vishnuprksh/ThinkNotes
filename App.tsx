...
const THEMES: AppTheme[] = [
  ...
  { name: 'Forest', bgPrimary: '#1a1d1a', bgSecondary: '#242924', borderPrimary: '#354035', accentPrimary: '#4ade80', textPrimary: '#d1fae5', textSecondary: '#6ee7b7', textHeaders: '#ffffff' },
  { name: 'Synthwave', bgPrimary: '#1a1625', bgSecondary: '#2f2b3a', borderPrimary: '#464255', accentPrimary: '#f472b6', textPrimary: '#e879f9', textSecondary: '#c084fc', textHeaders: '#fff' },
  { name: 'Bubblegum', bgPrimary: '#fff0f5', bgSecondary: '#ffeef5', borderPrimary: '#fbcfe8', accentPrimary: '#ec4899', textPrimary: '#831843', textSecondary: '#be185d', textHeaders: '#500724' },
  { name: 'Solarized', bgPrimary: '#fdf6e3', bgSecondary: '#eee8d5', borderPrimary: '#93a1a1', accentPrimary: '#268bd2', textPrimary: '#657b83', textSecondary: '#586e75', textHeaders: '#073642' }
];
...
`;
  ...
  const handleRandomTheme = useCallback(() => {
    const available = THEMES.filter(t => t.name !== currentTheme.name);
        ...
        <header className="h-14 border-b flex items-center justify-between px-3 sm:px-4 z-20 shrink-0" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-primary)' }}>
          ...
          <div className="flex items-center gap-1 sm:gap-3 ml-2">
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg border transition-all hover:bg-white/5"
              style={{
